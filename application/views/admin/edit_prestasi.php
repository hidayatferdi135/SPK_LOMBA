                                ...
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="container my-4">
                                        <?php foreach ($prestasi as $p): ?>
                                            <form action="<?= base_url('admin/update_prestasi') ?>" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_siswa" class="form-control" id="">
                                                        ...
                                                        <?php foreach ($siswa as $s): ?>
                                                            <option <?php if($s['id_siswa'] == $p['siswa_id']){echo "selected";} ?> value="<?= $s['id_siswa'] ?>"><?= $s['nama_siswa'] ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Prestasi</label>
                                                    <input type="text" class="form-control" value="<?= $p['prestasi'] ?>" name="prestasi">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select name="mapel" class="form-control" id="">
                                                        ...
                                                        <?php foreach ($pelajaran as $pel): ?>
                                                            <option <?php if($pel['id_pelajaran'] == $p['mapel']){echo "selected";} ?> value="<?= $pel['id_pelajaran'] ?>"><?= $pel['nama_pelajaran'] ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                </div>
